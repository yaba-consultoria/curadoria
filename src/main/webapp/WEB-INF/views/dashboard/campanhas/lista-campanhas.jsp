        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <div>
                        <!-- Botão Nova Campanha -->
                        <button class="btn btn-primary" data-toggle="modal" data-target="#modal-cadastro-campanha">Nova
                            Campanha
                        </button>
                    </div>
                </div>
                                    ...
                                    <c:forEach var="campanha" items="${campanhas}">
                                        <tr>
                                            <fmt:formatDate type="both" dateStyle="short" timeStyle="short"
                                                            value="${campanha.dataRegistro}" var="dataRegistro"/>
                                            <td>${dataRegistro}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="${context}/dashboard/campanhas/${campanha.id}"
                                                   title="Visualizar">
                                                    <i class="fas fa-sign-out-alt"></i>
                                                </a>
                                                <c:if test="${usuario.admin}">
                                                    <a href="${context}/dashboard/campanhas/${campanha.id}/excluir"
                                                       title="Excluir">
