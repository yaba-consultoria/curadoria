                ...
                <div class="d-flex flex-row justify-content-between flex-wrap">
                    ...
                    <c:if test = "${usuario.admin}">
                        <div>
                            ...
                            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-alterar-status-campanha">Alterar Status</button>
                            <!-- Botão Nova Campanha -->
                            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-cadastro-categoria-campanha">Nova Categoria</button>
                        </div>
                    </c:if>
                </div>
                                            ...
                                            <td>
                                                <c:choose>         
                                                 <c:when test = "${categoria.status eq 'CRIADO' and !usuario.admin}">
                                                    <a href="${context}/dashboard/campanhas/${campanha.id}/categorias/${categoria.id}" title="Visualizar" style="pointer-events: none; cursor: default; color: gray;">
                                                        <i class="far fa-list-alt"></i>
                                                    </a>
                                                 </c:when>                                                     
                                                 <c:when test = "${categoria.status eq 'CRIADO' and usuario.admin}">
                                                    <a href="${context}/dashboard/campanhas/${campanha.id}/categorias/${categoria.id}" title="Visualizar">
                                                        <i class="far fa-list-alt"></i>
                                                    </a>
                                                 </c:when>
                                                 <c:when test = "${categoria.status eq 'FECHADO' and !usuario.admin}">
                                                    <a href="${context}/dashboard/campanhas/${campanha.id}/categorias/${categoria.id}" title="Visualizar" style="pointer-events: none; cursor: default; color: red;">
                                                        <i class="far fa-list-alt"></i>
                                                    </a>
                                                 </c:when>                                                     
                                                 <c:otherwise>
                                                ...
                                                <c:if test = "${usuario.admin}">
                                                    <a href="${context}/dashboard/campanhas/${campanha.id}/categorias/${categoria.id}/excluir" title="Excluir">
                                                        <i class="far fa-times-circle ml-2"></i>
                                                    </a>
                                                </c:if>  
                                                <c:choose>         
                                                 <c:when test = "${categoria.status eq 'FECHADO'}">
                                                    <a href="${context}/dashboard/campanhas/${campanha.id}/categorias/${categoria.id}/resultados" title="Resultados">
                                                 ...
                                                 <c:otherwise>
                                                     <a href="${context}/dashboard/campanhas/${campanha.id}/categorias/${categoria.id}/resultados" title="Resultados" style="pointer-events: none; cursor: default; color: gray;">
                                                        <i class="fas fa-poll ml-2"></i>
                                                    </a>
                                                 </c:otherwise>
                                                </c:choose>                                                    
