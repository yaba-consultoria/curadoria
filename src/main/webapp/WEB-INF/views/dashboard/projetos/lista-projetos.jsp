        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <!-- Botão Nova Empresa -->
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal-cadastro-projeto">Novo
                        Projeto
                    </button>
                </div>
                        ...
                        <c:if test="${not empty projetos.content}">
                            <div class="row mt-3">
                                <div class="col-12 d-flex justify-content-start">
                                    <form action="${context}/dashboard/projetos"
                                          class="d-inline-block form-inline mr-5 mw-100 navbar-search" method="get">
                                        <div class="input-group">
                                            <input type="text" class="form-control small" name="titulo"
                                                   placeholder="Pesquisar por título ..." aria-label="Search"
                                    ...
                                    <!-- Import Topbar -->
                                    <c:import
                                            url="/WEB-INF/views/componentes/pagination/pagination-listar-projetos.jsp"/>
                                    <!-- End Import Topbar -->
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="mb-5 mt-2 d-flex flex-row justify-content-center">
                                                <a href="${context}/dashboard/projetos/${projeto.id}"
                                                   class="btn btn-info btn-icon-split mx-2">
                                      <span class="icon text-white-50">
                                        <i class="fas fa-sign-in-alt"></i>
                                      </span>
                                                    <span class="text">Detalhes</span>
                                                </a>
                                                <a href="${context}/dashboard/projetos/excluir/${projeto.id}"
